...
colorAPI.colorallRandom = function()
	...
	for i, prt in pairs(thngs) do
		spawn(function()
			...
			if prt:IsA("Part") or v:IsA("UnionOperation") or v:IsA("MeshPart") then colorAPI.color(prt, Color3.new(math.random(0, 255), math.random(0, 255), math.random(0, 255))) end
		end)
	end
end
